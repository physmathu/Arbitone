...
class KalshiClient:
    ...
    @staticmethod
    def quote_from_market(market: dict) -> MarketQuote:
        """
        Parses a MarketQuote directly out of a market dict returned by
        ...
        return MarketQuote(
            ...
            no_bid=to_cents(market.get("no_bid_dollars")),
            no_ask=to_cents(market.get("no_ask_dollars")),
            volume=int(float(market.get("volume_fp", 0))),
        )
